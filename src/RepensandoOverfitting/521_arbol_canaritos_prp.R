...
setwd("C:/ITBA/DM")  #establezco la carpeta donde voy a trabajar
#cargo el dataset
...
setwd("C:/ITBA/DM/labo/exp/ST5210/")   #Establezco el Working Directory DEL EXPERIMENTO

#genero la imagen del arbol
pdf( file= "arbol_canaritos_1.pdf", width=20, height=4)
